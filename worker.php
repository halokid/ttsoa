...
class Worker extends Zookeeper {
  ...
  public function __construct($host = '', $watcher_cb = null, $recv_timeout = 10) {
  ...
  public function watchPrevious()
  {
    ...
    throw new Exception( sprintf("something want very wrong! i can't find myself: %s/%s ",
                                  self::CONTAINER,
                                  $this->znode ));
